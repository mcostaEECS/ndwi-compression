...
if __name__ == "__main__":
    ...
    #window = rasterio.windows.Window(800,1400,3000,1000) # winter
    #window = rasterio.windows.Window(1000,1000,3000,1000) # summer
    window = rasterio.windows.Window(500,1500,3000,1000) # sea check in the winter (Västerskaten)
