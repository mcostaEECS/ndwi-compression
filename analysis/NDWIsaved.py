...
if __name__ == "__main__":
    ...
    path = 'data/summer/%s.tif'%data[idx]; window = rasterio.windows.Window(1000,1000,3000,1000)
    #path = 'data/winter/%s.tif'%data[idx]; window = rasterio.windows.Window(800,1400,3000,1000)
    #path = 'data/sea/%s.tif'%data[idx]; window = rasterio.windows.Window(500,1500,3000,1000) # sea check in the winter (Västerskaten)
